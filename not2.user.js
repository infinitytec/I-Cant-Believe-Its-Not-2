...
(function() {
   ...
   // import @comp09's filters from tjvr/scratchblocks
    ...
    GM_addStyle(".gui_editor-wrapper_2DYcj {position: absolute; width: calc(100% - 500px); right:0; height: 95%;}");
    GM_addStyle(".gui_stage-and-target-wrapper_69KBf {position: absolute; width: 40%; left: 0; height: 95%;}");
